...
const Home = () => {
  return (
    <div className="text-white font-1">
      ...
      <Link to='/register' className="w-36 mt-8 p-2 border rounded-md font-bold text-lg ml-[700px] bg-indigo-800 border-indigo-700 cursor-pointer flex items-center justify-center gap-1.5">
